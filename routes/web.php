...
Route::middleware(['auth', 'is_admin'])->group(function () {
    ...
    // Admin Cases Management (view all cases from all lawyers)
    Route::get('/admin/cases', [\App\Http\Controllers\Admin\CaseController::class, 'index'])->name('admin.cases.index');
    Route::get('/admin/cases/{id}', [\App\Http\Controllers\Admin\CaseController::class, 'show'])->name('admin.cases.show');

    // Admin Invoices Management (view all invoices from all lawyers)
