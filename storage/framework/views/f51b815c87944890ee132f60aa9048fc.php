        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-6 mb-4 mb-md-0">
                    <h6 class="fw-bold mb-3"><?php echo e(__('messages.footer_platform')); ?></h6>
                ...
                <div class="col-md-2 col-6 mb-4 mb-md-0">
                    <h6 class="fw-bold mb-3"><?php echo e(__('messages.footer_company')); ?></h6>
                    <ul class="list-unstyled">
                ...
                <div class="col-md-4">
                    <h6 class="fw-bold mb-3"><?php echo e(__('messages.footer_subscribe')); ?></h6>
