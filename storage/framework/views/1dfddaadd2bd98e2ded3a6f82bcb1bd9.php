        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('lawyer.cases.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="status"
                                    ...
                                    <option value="completed" <?php echo e(old('status') == 'completed' ? 'selected' : ''); ?>>
                                        Completed</option>
                                    <option value="closed" <?php echo e(old('status') == 'closed' ? 'selected' : ''); ?>>Closed
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                        id="hearing_time" name="hearing_time" value="<?php echo e(old('hearing_time')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['court_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    id="court_location" name="court_location" value="<?php echo e(old('court_location')); ?>">
                                <?php $__errorArgs = ['court_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('lawyer.cases.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Defence\LawLite\resources\views/lawyer/cases/create.blade.php ENDPATH**/ ?>