            ...
            <?php $__empty_1 = true; $__currentLoopData = $lawyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lawyer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e($lawyer->user->name ?? __('messages.unnamed_lawyer')); ?></h5>
                            <p class="card-text text-muted"><?php echo e($lawyer->expertise ?? __('messages.general_practice')); ?></p>
                            <p class="mb-1"><small class="text-muted"><?php echo e(__('messages.location')); ?>:
                                    <?php echo e($lawyer->city ?? __('messages.unknown')); ?></small>
                            </p>
                            <a href="<?php echo e(route('lawyers.show', $lawyer->id)); ?>"
                                class="btn btn-sm btn-outline-primary mt-2"><?php echo e(__('messages.view_profile')); ?></a>
                        </div>
                    </div>
                </div>
