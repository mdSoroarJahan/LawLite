                    ...
                    <tbody>
                        @forelse ($articles as $article)
                            <tr>
                                ...
                                <td>{{ $article->published_at ? \Carbon\Carbon::parse($article->published_at)->format('M d, Y') : '-' }}
                                </td>
                                <td class="text-end pe-4">
                                    <a href="{{ route('lawyer.articles.edit', $article->id) }}"
                                        class="btn btn-sm btn-outline-secondary me-1">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('lawyer.articles.destroy', $article->id) }}" method="POST"
