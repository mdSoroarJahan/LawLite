        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <p class="lead small-muted">Connect with verified lawyers, get fast AI-powered summaries, and manage appointments — all in one modern, secure app.</p>
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="card card-ghost p-4">
                        ...
                        <p class="small-muted">Ask legal questions in natural language and get concise summaries and next steps.</p>
                        <hr>
                        <h6 class="mb-1">Featured lawyers</h6>
                        @php
                            $sample = (object) ['name' => 'Adv. Rahman', 'expertise' => 'Family Law, Civil', 'city' => 'Dhaka', 'verified' => true, 'photo' => null];
                        @endphp
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-md-4">
                    <div class="card p-4 h-100 card-ghost">
                        <h5>AI Summaries</h5>
                        <p class="small-muted mb-0">Short, bilingual summaries of legal text and contracts to speed decisions.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-4 h-100 card-ghost">
