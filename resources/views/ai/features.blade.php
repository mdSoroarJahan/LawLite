                    ...
                    <div class="tool-panel" id="tool-rights">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="rights-category">
                                <option value="arrest">{{ __('messages.rights_arrest') }}</option>
                                <option value="women">{{ __('messages.rights_women') }}</option>
                                <option value="children">{{ __('messages.rights_children') }}</option>
                                <option value="consumer">{{ __('messages.rights_consumer') }}</option>
                                <option value="property">{{ __('messages.rights_property') }}</option>
                                <option value="labour">{{ __('messages.rights_labour') }}</option>
                                <option value="cyber">{{ __('messages.rights_cyber') }}</option>
                            </select>
                        </div>

                        <button class="btn btn-primary px-4" onclick="checkRights()">
