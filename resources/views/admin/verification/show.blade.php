        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <img src="{{ \Illuminate\Support\Facades\Storage::url($lawyer->user->profile_photo_path) }}" class="rounded-circle mb-3"
            ...
            <div class="card">
                ...
                <div class="card-body d-grid gap-2">
                    ...
                    @if ($lawyer->verification_status === 'verified')
                    <div class="alert alert-success mb-0 py-2 text-center">Already verified</div>
                    @endif
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card h-100">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{ \Illuminate\Support\Facades\Storage::url($doc) }}" target="_blank"
